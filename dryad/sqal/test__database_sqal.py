...
class TestDatabase(unittest.TestCase):
    ...
    def setUp(self):
        self.ddb = DryadDatabase(db_name="sqlite:///dryad_test_database.db")
    ...
    def test_system_param_info(self):
        ...
        self.assertEqual(self.ddb.close_session(), True)
    ...
    def test_node_device(self):
        ...
        result = self.ddb.get_nodes(name="SN01")
        self.assertEqual(result.site_name, "GS01")

        result = self.ddb.get_nodes(node_class="SENSOR")
        self.assertEqual(len(result), 2)

        result = self.ddb.get_nodes()
    ...
    def test_session(self):
        ...
        self.assertEqual(self.ddb.get_current_session().end_time, -1)
        self.ddb.terminate_session()
        self.assertEqual(self.ddb.get_current_session(), False)
